...
export function StatusBar() {
  ...
  return (
    <>
      <footer className="h-6 min-h-[1.5rem] flex items-center justify-between px-2 text-xs select-none" style={{ backgroundColor: 'var(--statusbar-bg)', color: 'var(--statusbar-fg)' }}>
